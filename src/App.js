    ...
    return (
      <>
        <Router>
          ...
          />
          <Routes>
            <Route exact path='/' element={<News setProgress={this.setProgress} apikey={this.apikey} key="home" pageSize={this.pageSize} country='us' category="genral" />} />
            <Route exact path='/genral' element={<News setProgress={this.setProgress} apikey={this.apikey} key="genral" pageSize={this.pageSize} country='us' category="genral" />} />
            ...
            <Route exact path='/technology' element={<News setProgress={this.setProgress} apikey={this.apikey} key="technolog" pageSize={this.pageSize} country='us' category="technology" />} />
          </Routes >
        </Router >
      </>
    )
...
// import News setProgress={this.setProgress} apikey={this.apikey}     from './components/News setProgress={this.setProgress} apikey={this.apikey}    ';
